...
│   └── generator.py            # DbtModelGenerator (611 lines)
│
...
│   ├── post_sync.py            # Post-sync hook dispatcher (~618 lines)
...
| `utils/post_sync.py` | 618 | — (post-sync hooks + sync notification) |
...
| `transformation/generator.py` | 611 | — |
