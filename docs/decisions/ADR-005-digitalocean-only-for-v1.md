...
- **Right-sized for small teams:** The `s-2vcpu-4gb` tier ($24/mo) provides 2 vCPUs, 4GB RAM, and 80GB disk — sufficient for DuckDB, Metabase, dbt, and the Dango server. A Performance tier (`s-4vcpu-8gb`, $48/mo) is available for heavier workloads.
