            ...
            while True:
                if client_id and client_secret:
                    ...
                    instructions = [
                        ...
                        "",
                        f"2. Enable the [bold]{api_name}[/bold] FIRST — Google Auth Platform",
                        "   (step 3) only appears in the nav once an API is enabled:",
                        ...
                        "   • First time in this project: click [bold]Get started[/bold] and",
                        "     walk the 4-step wizard — App Information, then",
                        "     [bold]Audience[/bold] (select [yellow]External[/yellow] here —",
                        "     this is where User Type now lives, there is no separate",
                        '     "External" button), then Contact Information, then Create',
                        "   • Already configured from a previous Google source in this",
                        "     project? You'll land directly on a tabbed dashboard instead —",
                        "     nothing further needed here, skip to step 4",
                        "",
                        "4. Add a test user (Testing-status apps only):",
                        "   • Google Auth Platform > [bold]Audience[/bold] tab > Test users >",
                        "     Add users > enter your Google account email",
                        "   • If your app's Publishing status is already",
                        "     [bold]In production[/bold], this section won't appear — that's",
                        "     expected, skip this step",
                        "",
                        "5. Create OAuth 2.0 credentials:",
                        "   • Google Auth Platform > [bold]Clients[/bold] tab > Create Client",
                        "   • Application type: [yellow]Web application[/yellow]",
                        f"   • Add Authorized redirect URI: {self.oauth_manager.callback_url}",
                        "   • Copy the Client ID and Client Secret",
                        "",
                        "[yellow]⚠  First-time consent screen:[/yellow] you'll likely see",
                        '   "Google hasn\'t verified this app" — this is expected for an',
                        "   unverified app requesting this scope. Click",
                        "   [bold]Advanced[/bold] > [bold]Go to (app name) (unsafe)[/bold] to",
                        "   proceed. This applies whether your app is Testing or Production —",
                        "   verification status, not publishing status, controls this warning.",
                        "",
