...
class ShopifyOAuthProvider(BaseOAuthProvider):
    ...
    def authenticate(self, source_name: str | None = None) -> str | None:
        ...
        try:
            ...
            # Save credentials
            credentials = {"private_app_password": access_token, "shop_url": shop_url}
            ...
            console.print("[cyan]OAuth credentials saved for:[/cyan] shopify")
    ...
    def _test_connection(self, shop_url: str, access_token: str) -> str | None:
        """
