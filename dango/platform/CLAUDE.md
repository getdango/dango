...
|------|---------|-------------|
| `docker.py` | Docker Compose lifecycle + persisted project-identity (1.0.8-Q9) + collision guard (1.0.8-Q8) | `DockerManager`, `ServiceStatus`, `get_compose_project_name()`, `_get_existing_container_working_dirs()`, `_legacy_path_hash()` |
