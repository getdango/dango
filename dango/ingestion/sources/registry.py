...
SOURCE_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "facebook_ads": {
        ...
        "column_descriptions": {
            "campaigns": {
                ...
                "name": "Campaign name",
                "status": "Campaign status: ACTIVE, PAUSED, DELETED, or ARCHIVED",
                "objective": "Campaign objective: LINK_CLICKS, CONVERSIONS, REACH, etc.",
                "buying_type": "Buying type: AUCTION or RESERVED",
                "start_time": "Campaign start time",
                "stop_time": "Campaign end time (if set)",
                "daily_budget": "Daily budget in account currency (smallest unit)",
                "lifetime_budget": "Lifetime budget in account currency (smallest unit)",
            ...
            "ad_sets": {
                ...
                "status": "Ad set status: ACTIVE, PAUSED, DELETED, or ARCHIVED",
                "daily_budget": "Daily budget for this ad set in account currency (smallest unit)",
                "lifetime_budget": "Lifetime budget for this ad set in account currency (smallest unit)",
                "start_time": "Ad set start time",
                "end_time": "Ad set end time (if set)",
                "bid_amount": "Bid amount in account currency (smallest unit)",
            },
            "ads": {
                ...
                "campaign_id": "ID of the parent campaign",
                "status": "Ad status: ACTIVE, PAUSED, DELETED, or ARCHIVED",
            },
            "facebook_insights": {
    ...
    "google_analytics": {
        ...
        "column_descriptions": {
            "traffic": {
                "date": "Report date",
                "session_source": "Traffic source (e.g., google, facebook, direct)",
                "session_medium": "Traffic medium (e.g., organic, cpc, email)",
                "session_campaign_name": "Campaign name that drove the session",
                "session_default_channel_group": "Default channel grouping (e.g., Organic Search, Paid Social)",
                "device_category": "Device category: desktop, mobile, or tablet",
                "operating_system": "User's operating system",
                "browser": "User's browser",
                "sessions": "Total number of sessions",
                "engaged_sessions": "Sessions with engagement (10+ seconds, conversion, or 2+ pages)",
                "total_users": "Total number of unique users",
                "new_users": "Number of users visiting for the first time",
                "average_session_duration": "Average session duration in seconds",
                "bounce_rate": "Percentage of sessions that were not engaged",
            },
            "pages": {
                "date": "Report date",
                "page_path": "URL path of the page",
                "page_title": "Title of the page",
                "session_source": "Traffic source that led to this page view",
                "session_medium": "Traffic medium that led to this page view",
                "device_category": "Device category: desktop, mobile, or tablet",
                "screen_page_views": "Total number of page views",
                "total_users": "Total number of unique users who viewed this page",
                "user_engagement_duration": "Total engagement time in seconds",
                "sessions": "Total number of sessions that included this page",
                "bounce_rate": "Percentage of sessions that were not engaged",
            },
            "landing_pages": {
                "date": "Report date",
                "landing_page": "First page URL path of the session",
                "session_source": "Traffic source that drove the session",
                "session_medium": "Traffic medium that drove the session",
                "session_campaign_name": "Campaign name that drove the session",
                "session_default_channel_group": "Default channel grouping",
                "device_category": "Device category: desktop, mobile, or tablet",
                "sessions": "Total number of sessions starting on this page",
                "total_users": "Total number of unique users",
            ...
            "geo": {
                "date": "Report date",
                "country": "Country where the session originated",
                "city": "City where the session originated",
                "language": "Language setting of the user's browser",
                "device_category": "Device category: desktop, mobile, or tablet",
                "sessions": "Total number of sessions from this location",
                "total_users": "Total number of unique users from this location",
                "engaged_sessions": "Sessions with engagement from this location",
                "bounce_rate": "Percentage of sessions that were not engaged",
            },
            "events": {
                "date": "Report date",
                "event_name": "Name of the event (e.g., page_view, click, purchase)",
                "session_source": "Traffic source when the event occurred",
                "session_medium": "Traffic medium when the event occurred",
                "landing_page": "Landing page URL when the event occurred",
                "device_category": "Device category: desktop, mobile, or tablet",
                "event_count": "Total number of times this event occurred",
                "total_users": "Total number of unique users who triggered this event",
                "event_count_per_user": "Average number of times each user triggered this event",
                "sessions": "Total number of sessions that included this event",
            },
            "conversions": {
                "date": "Report date",
                "session_source": "Traffic source attributed to the conversion",
                "session_medium": "Traffic medium attributed to the conversion",
                "session_campaign_name": "Campaign attributed to the conversion",
                "session_default_channel_group": "Channel group attributed to the conversion",
                "landing_page": "Landing page associated with the converting session",
                "device_category": "Device category: desktop, mobile, or tablet",
                "conversions": "Total number of conversions",
                "total_revenue": "Total revenue from conversions",
                "total_users": "Total unique users who converted",
                "sessions": "Total sessions that resulted in a conversion",
                "engaged_sessions": "Engaged sessions that resulted in a conversion",
            },
        },
    },
    # ========================================
    ...
    "hubspot": {
        ...
        "column_descriptions": {
            "contacts": {
                ...
                "createdate": "Timestamp when the contact was created",
                "lastmodifieddate": "Timestamp when the contact was last modified",
                "hs_lead_status": "Lead status: NEW, OPEN, IN_PROGRESS, QUALIFIED, etc.",
                "hs_object_id": "Internal HubSpot object ID",
            },
            "companies": {
                ...
                "createdate": "Timestamp when the company was created",
                "lastmodifieddate": "Timestamp when the company was last modified",
                "hs_object_id": "Internal HubSpot object ID",
            },
            "deals": {
                "id": "Unique HubSpot deal ID",
                "dealname": "Deal name",
                "dealstage": "Current pipeline stage ID",
                "pipeline": "Pipeline ID the deal belongs to",
                "amount": "Deal amount in account currency",
                "closedate": "Expected or actual close date",
                "createdate": "Timestamp when the deal was created",
                "lastmodifieddate": "Timestamp when the deal was last modified",
                "hs_deal_stage_probability": "Win probability for the current stage (0-1)",
                "hs_object_id": "Internal HubSpot object ID",
            },
            "tickets": {
                "id": "Unique HubSpot ticket ID",
                "subject": "Ticket subject",
                "hs_pipeline_stage": "Current pipeline stage ID",
                "hs_ticket_priority": "Ticket priority: LOW, MEDIUM, HIGH, or URGENT",
                "createdate": "Timestamp when the ticket was created",
                "lastmodifieddate": "Timestamp when the ticket was last modified",
                "hs_object_id": "Internal HubSpot object ID",
            },
        },
    },
    "salesforce": {
        ...
        "column_descriptions": {
            "account": {
                "id": "Unique Salesforce account ID",
                "name": "Account name",
                "type": "Account type: Customer, Partner, Prospect, etc.",
                "industry": "Industry category",
            ...
            "contact": {
                "id": "Unique Salesforce contact ID",
                ...
                "created_date": "Timestamp when the contact was created",
                "last_modified_date": "Timestamp when the contact was last modified",
            },
            "lead": {
                "id": "Unique Salesforce lead ID",
                "first_name": "Lead first name",
                "last_name": "Lead last name",
                "email": "Lead email address",
                "phone": "Lead phone number",
                "company": "Lead company name",
                "status": "Lead status: Open, Working, Qualified, Converted, etc.",
                "is_converted": "Whether the lead has been converted to an account/contact/opportunity",
                "created_date": "Timestamp when the lead was created",
                "last_modified_date": "Timestamp when the lead was last modified",
            },
            "opportunity": {
                "id": "Unique Salesforce opportunity ID",
                "name": "Opportunity name",
                "account_id": "ID of the associated account",
                "stage_name": "Current sales stage name",
                "amount": "Opportunity amount in account currency",
                ...
                "is_closed": "Whether the opportunity is closed (won or lost)",
                "created_date": "Timestamp when the opportunity was created",
                "last_modified_date": "Timestamp when the opportunity was last modified",
            },
        },
    },
    # ========================================
    ...
    "stripe": {
        ...
        "column_descriptions": {
            "charge": {
                ...
                "amount": "Amount charged in the smallest currency unit (e.g., cents)",
                "currency": "Three-letter ISO currency code",
                "status": "Charge status: succeeded, pending, or failed",
                "customer": "ID of the customer this charge belongs to",
                "created": "Unix timestamp when the charge was created",
                ...
                "failure_code": "Error code explaining why the charge failed",
                "failure_message": "Human-readable explanation of the charge failure",
            },
            "customer": {
                ...
                "balance": "Current balance, in smallest currency unit, that this customer has",
            },
            "subscription": {
                ...
                "cancel_at_period_end": "If true, subscription cancels at end of current period",
            },
            "invoice": {
                "id": "Unique identifier for the invoice",
                "customer": "ID of the customer this invoice belongs to",
                "status": "Invoice status: draft, open, paid, void, uncollectible",
                "total": "Total amount due in smallest currency unit",
                "amount_paid": "Amount already paid on this invoice",
                "amount_remaining": "Amount remaining to be paid",
                "currency": "Three-letter ISO currency code",
                "created": "Unix timestamp when the invoice was created",
            ...
            "product": {
                ...
                "created": "Unix timestamp when the product was created",
            ...
            "price": {
                ...
                "currency": "Three-letter ISO currency code",
                "unit_amount": "Unit amount in smallest currency unit",
                "active": "Whether the price is available for purchase",
    ...
    "shopify": {
        ...
        "column_descriptions": {
            "orders": {
                ...
                "email": "Customer email address for this order",
                "total_price": "Total price of the order including taxes and discounts",
                "subtotal_price": "Price of the order before taxes and shipping",
                "currency": "Three-letter ISO currency code",
                "financial_status": "Payment status: pending, authorized, paid, refunded, voided, etc.",
                "fulfillment_status": "Fulfillment status: fulfilled, partial, unfulfilled, or null",
                ...
                "total_tax": "Total tax amount charged on the order",
            },
            "customers": {
                "id": "Unique identifier for the customer",
                "email": "Customer email address",
                ...
                "phone": "Customer phone number",
                "orders_count": "Total number of orders placed by this customer",
                "total_spent": "Total amount spent by this customer",
                "state": "Customer account state: enabled, disabled, invited, or declined",
            ...
            "products": {
                "id": "Unique identifier for the product",
                "title": "Product title",
                "vendor": "Product vendor or brand name",
                "product_type": "Custom product type or category",
                "status": "Product status: active, archived, or draft",
                "handle": "URL-friendly identifier for the product",
                "created_at": "Timestamp when the product was created",
                "updated_at": "Timestamp when the product was last updated",
                "published_at": "Timestamp when the product was published (null if unpublished)",
            },
        },
    },
    # ========================================
    ...
    "google_ads": {
        ...
        "column_descriptions": {
            "campaign_stats": {
                ...
                "campaign_name": "Name of the campaign",
                "campaign_status": "Campaign status: ENABLED, PAUSED, or REMOVED",
                "campaign_advertising_channel_type": "Advertising channel type: SEARCH, DISPLAY, VIDEO, etc.",
                "campaign_bidding_strategy_type": "Bidding strategy: TARGET_CPA, MAXIMIZE_CLICKS, etc.",
                "impressions": "Number of times the ad was shown",
                "clicks": "Number of clicks on the ad",
                "cost_micros": "Total cost in micros (divide by 1,000,000 for currency amount)",
                "conversions": "Number of conversions attributed to the campaign",
                "conversions_value": "Total conversion value attributed to the campaign",
                "ctr": "Click-through rate (clicks / impressions)",
                "average_cpc": "Average cost-per-click in micros",
                "average_cpm": "Average cost-per-thousand impressions in micros",
                "search_impression_share": "Impressions received / estimated eligible impressions",
                "search_rank_lost_impression_share": "Impression share lost due to ad rank",
                "search_budget_lost_impression_share": "Impression share lost due to budget",
                "search_top_impression_share": "Impressions at the top of page / eligible top impressions",
                "search_absolute_top_impression_share": "Impressions in absolute top position / eligible",
            },
            "ad_group_stats": {
                "date": "Report date",
                "campaign_id": "Unique identifier for the campaign",
                ...
                "ad_group_status": "Ad group status: ENABLED, PAUSED, or REMOVED",
                "ad_group_type": "Ad group type: SEARCH_STANDARD, DISPLAY_STANDARD, etc.",
                "impressions": "Number of times ads in this group were shown",
                "clicks": "Number of clicks on ads in this group",
                "cost_micros": "Total cost in micros (divide by 1,000,000 for currency amount)",
                "conversions": "Number of conversions attributed to this ad group",
                "conversions_value": "Total conversion value attributed to this ad group",
                "ctr": "Click-through rate (clicks / impressions)",
                "average_cpc": "Average cost-per-click in micros",
            },
            "keyword_stats": {
                ...
                "ad_group_criterion_keyword_match_type": "Match type: BROAD, PHRASE, or EXACT",
                "ad_group_criterion_quality_info_quality_score": "Quality score from 1-10",
                "ad_group_criterion_quality_info_creative_quality_score": "Ad relevance quality score",
                "ad_group_criterion_quality_info_post_click_quality_score": "Landing page quality score",
                "ad_group_criterion_quality_info_search_predicted_ctr": "Expected CTR quality score",
                "impressions": "Number of times the keyword triggered an ad impression",
                "clicks": "Number of clicks on ads triggered by this keyword",
                "cost_micros": "Total cost in micros (divide by 1,000,000 for currency amount)",
                "conversions": "Number of conversions attributed to this keyword",
                "ctr": "Click-through rate (clicks / impressions)",
                "average_cpc": "Average cost-per-click in micros",
                "search_impression_share": "Impression share for this keyword",
            },
            "ad_stats": {
                "date": "Report date",
                "campaign_id": "Unique identifier for the campaign",
                ...
                "ad_group_id": "Unique identifier for the ad group",
                "ad_group_name": "Name of the ad group",
                "ad_group_ad_ad_id": "Unique identifier for the ad",
                "ad_group_ad_ad_name": "Name of the ad",
                "ad_group_ad_ad_type": "Ad type: EXPANDED_TEXT_AD, RESPONSIVE_SEARCH_AD, etc.",
                "ad_group_ad_status": "Ad status: ENABLED, PAUSED, or REMOVED",
                "impressions": "Number of times the ad was shown",
                "clicks": "Number of clicks on the ad",
                "cost_micros": "Total cost in micros (divide by 1,000,000 for currency amount)",
                "conversions": "Number of conversions attributed to this ad",
                "conversions_value": "Total conversion value attributed to this ad",
                "ctr": "Click-through rate (clicks / impressions)",
            },
            "search_term_stats": {
                "date": "Report date",
                ...
                "ad_group_id": "Unique identifier for the ad group",
                "ad_group_name": "Name of the ad group",
                "search_term_view_search_term": "The actual search query that triggered the ad",
                "search_term_view_status": "Whether the search term is added, excluded, or none",
                "impressions": "Number of times the search term triggered an impression",
                "clicks": "Number of clicks from this search term",
                "cost_micros": "Total cost in micros (divide by 1,000,000 for currency amount)",
                "conversions": "Number of conversions from this search term",
                "ctr": "Click-through rate (clicks / impressions)",
                "average_cpc": "Average cost-per-click in micros",
            },
            "geographic_stats": {
                ...
                "geographic_view_location_type": "Location type: LOCATION_OF_PRESENCE or LOCATION_OF_INTEREST",
                "impressions": "Number of impressions in this geography",
                "clicks": "Number of clicks in this geography",
                "cost_micros": "Total cost in micros (divide by 1,000,000 for currency amount)",
                "conversions": "Number of conversions in this geography",
                "conversions_value": "Total conversion value in this geography",
            },
            "device_stats": {
                "date": "Report date",
                "device": "Device type: DESKTOP, MOBILE, TABLET, or CONNECTED_TV",
                "campaign_id": "Unique identifier for the campaign",
                "campaign_name": "Name of the campaign",
                "impressions": "Number of impressions on this device type",
                "clicks": "Number of clicks on this device type",
                "cost_micros": "Total cost in micros (divide by 1,000,000 for currency amount)",
                "conversions": "Number of conversions on this device type",
                "conversions_value": "Total conversion value on this device type",
                "ctr": "Click-through rate (clicks / impressions)",
                "average_cpc": "Average cost-per-click in micros",
            },
        },
