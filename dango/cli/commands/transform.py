...
@click.option(
    "--force",
    is_flag=True,
    help="Overwrite customized models too (ignore the auto-generated marker comment)",
)
@click.pass_context
def generate(ctx: click.Context, models: bool, generate_all: bool, force: bool) -> None:
    """
    ...
    Models with the "-- Auto-generated by Dango" marker comment removed are
    treated as customized and skipped, unless --force is passed.

    Examples:
      dango generate --models      Generate staging models only
      dango generate --all         Generate models + schema.yml
      dango generate --force       Also overwrite customized models
    ...
    try:
        ...
        # Respect the auto-generated marker by default — same contract as
        # the post-sync path. --force bypasses it.
        summary = generator.generate_all_models(
            sources=sources,
            generate_schema_yml=generate_all,
            skip_customized=not force,
        )
